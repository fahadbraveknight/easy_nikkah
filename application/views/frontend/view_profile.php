			    		...
			    		if(!empty($relationship)){
					    	...
					    	case 'awaiting_response':
					    	 	if($this->session->userdata('userid') == $relationship['from_id']){
					    			$data_message = $groom['full_name'].' has not yet responded to your proposal.';
					    		}
					    	...
					    	case 'need_more_time':
					    	 	if($this->session->userdata('userid') == $relationship['from_id']){
					    			$data_message = $groom['full_name'].' needs more time to think about the Proposal.';
					    		}
					    		elseif($this->session->userdata('userid') == $relationship['to_id']){
									$data_status = 'accepted';
					    			$data_value = 'Accept';
					    	...
					    	case 'declined':
								if($this->session->userdata('userid') == $relationship['from_id']){
					    			$data_message = $groom['full_name'].' has declined your proposal.';
					    		}
					    		elseif($this->session->userdata('userid') == $relationship['to_id']){
