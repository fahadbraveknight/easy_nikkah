<div class="contact-person-view" contact-data-key="<?php echo $contact_data_key  ?>">
...
<div class="form-group">
    ...
    <input type="text" id="edit-contact-person-relation" name="contact_person[<?php echo $contact_data_key  ?>][contact_person_relation]" value="" size="60" maxlength="60" class="form-text required">
</div>
</div>