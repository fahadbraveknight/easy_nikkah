            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" action="">
                            ...
                            <div class="col-sm-10">
                                <select class="chosen-select" name="state_id" style="width:150px;" tabindex="2" required="">
                                    <?php foreach ($states as $state) { ?>
                                        <option value="<?php echo $state['state_id']; ?>" <?php echo ($city['state_id'] == $state['state_id']) ? 'selected' : '' ?>><?php echo $state['state_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" required name="city_name" value="<?php echo $city['city_name']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
							<select class="chosen-select" name="status" style="width:150px;" tabindex="2" required="">
								<option value="active" <?php echo ($city['city_status'] == 'active') ? 'selected' : '' ?>>Active</option>
								<option value="inactive" <?php echo ($city['city_status'] == 'inactive') ? 'selected' : '' ?>>Inactive</option>
							</select>
						</div>
                    </div>
                    <div class="form-group">
